...
public class PathTemplate implements Comparable<PathTemplate> {
    ...
    public static PathTemplate create(final String inputPath) {
            ...
            switch (state) {
                ...
                case 3: {
                    if (c == '/') {
                        ...
                        throw new IllegalArgumentException("could not parse uri template " + path + " at " + i);
                    }
                    break;
                }
                case 4: {
        ...
        switch (state) {
            ...
            case 2: {
                throw new RuntimeException("could not parse uri template " + path  + " length:" + path.length());
            }
            case 4: {
                trailingSlash = true;
                break;
